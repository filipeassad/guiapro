...
public class GetEspecialidadesAsynctask extends AsyncTask<String, String, JSONArray> {
    ...
    public GetEspecialidadesAsynctask(Context contexto, EspecialidadesInterface especialidadesInterface) {
    ...
    protected void onPostExecute(JSONArray jsonArray) {
        ...
        progress.dismiss();
        especialidadesInterface.retornoGetEspecialidades(carregaDados.montarEspecialidades(jsonArray));
    }
}
