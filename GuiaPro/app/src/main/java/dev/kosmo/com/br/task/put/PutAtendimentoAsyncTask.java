...
public class PutAtendimentoAsyncTask extends AsyncTask<String, String, HashMap<String, Object>> {
    ...
    public PutAtendimentoAsyncTask(Context contexto, JSONObject jsonObject, AtendimentoInterface atendimentoInterface) {
    ...
    protected void onPostExecute(HashMap<String, Object> resultado) {
        ...
        atendimentoInterface.retornoAlteracaoAtendimentos(cadastrou);
    }
