package dev.kosmo.com.br.task.put;
...
public class PutEnderecoAsyncTask extends AsyncTask<String, String, HashMap<String, Object>> {

    private Context contexto;
    private ProgressDialog progress;
    private JSONObject jsonObject;
    private PutEnderecoInterface putEnderecoInterface;
    ...
    public PutEnderecoAsyncTask(Context contexto, JSONObject jsonObject, PutEnderecoInterface putEnderecoInterface) {
        this.contexto = contexto;
        this.jsonObject = jsonObject;
        this.putEnderecoInterface = putEnderecoInterface;
    }
    ...
    private HashMap<String, Object> validaResposta(JSONObject response){
        ...
        try {
            if(response.has("success") && response.getBoolean("success")){
                resultado.put("alterou", response.getBoolean("success"));
            }else{
                resultado.put("alterou", response.getBoolean("success"));
    ...
    protected void onPostExecute(HashMap<String, Object> resultado) {
        ...
        if(resultado != null && resultado.get("alterou") != null)
            cadastrou = (Boolean) resultado.get("alterou");

        putEnderecoInterface.retornoAlteracao(cadastrou);
